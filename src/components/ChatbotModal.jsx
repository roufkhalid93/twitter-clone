...
export default function ChatbotModal({ show, handleClose }) {
    ...
    const sendMessage = async (e) => {
        ...
        const apiKey = import.meta.env.VITE_OPENAI_API_KEY; // replace this with your own apiKey from openAI
        ...
        if (data) {
            ...
            setMessage('') //clear the box to empty string to allow new question to be asked
        }
    }
